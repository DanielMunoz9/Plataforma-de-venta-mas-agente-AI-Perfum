...
CREATE TABLE `carrito_producto` (
  ...
  CONSTRAINT `carrito_producto_ibfk_1` FOREIGN KEY (`id_carrito`) REFERENCES `carritos` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `carritos` (
  ...
  CONSTRAINT `carritos_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `estado_orden_compra`
--
...
--
-- Dumping data for table `estado_orden_compra`
--

LOCK TABLES `estado_orden_compra` WRITE;
/*!40000 ALTER TABLE `estado_orden_compra` DISABLE KEYS */;
INSERT INTO `estado_orden_compra` VALUES (4,'cancelado'),(3,'enviado'),(2,'pagado'),(1,'pendiente');
/*!40000 ALTER TABLE `estado_orden_compra` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `roles` VALUES (2,'administrador'),(1,'cliente');
...
-- Dump completed on 2025-07-13  9:39:32
